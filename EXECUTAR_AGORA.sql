-- EXECUTE ESTE SCRIPT NO HOSTINGER AGORA
...
INSERT INTO establishments (name, type, address, description, google_maps_url) 
VALUES ('Bar Teste', 'bar', 'Rua Teste, 123', 'Bar de teste', 'https://maps.google.com/teste');
